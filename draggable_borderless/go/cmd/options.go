...
func (p *AppBarDraggable) InitPlugin(messenger plugin.BinaryMessenger) error {
	...
	channel.HandleFuncSync("onMaximize", p.onMaximize)
	channel.HandleFuncSync("onRestore", p.onRestore)
	return nil
}
...
func (p *AppBarDraggable) onMaximize(arguments interface{}) (reply interface{}, err error) {
	// This function may be called from any thread. Access is not synchronized.
	p.window.SetSize(1400, 800)
	// p.window.Maximize()
	return nil, nil
}

func (p *AppBarDraggable) onRestore(arguments interface{}) (reply interface{}, err error) {
	// This function may be called from any thread. Access is not synchronized.
	p.window.Restore()
	return nil, nil
}
